...
* [**Kramarczuk's**](https://kramarczuks.com/)  
  *215 E Hennepin Ave, Minneapolis, MN 55414*  
  ...
  for over 60 years. Walk across the river to here to combine the trip with
  checking out the St. Anthony Falls area (mentioned in <a
  class="anchor-only" href="#things-to-do">Things to Do</a>)
...
* Head to the north side of downtown and walk across the iconic [Stone Arch Bridge](https://www.minneapolisparks.org/parks__destinations/historical_sites/stone_arch_bridge/)
  ...
  See all the mill buildings along the riverside? 'The Mill City' developed around these falls. Ever heard of [General Mills](https://en.wikipedia.org/wiki/General_Mills) and [Pillsbury](https://en.wikipedia.org/wiki/Pillsbury_Company)?
